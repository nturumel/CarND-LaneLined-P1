...
def main():
    ...
    print ("Hough Rho : %f" % edge_finder.houghRho())
    print ("Hough Theta : %f" % edge_finder.houghTheta())
    print ("Hough Threshold : %f" % edge_finder.houghThreshold())
    print ("Hough Min Line Length : %f" % edge_finder.houghMinLineLength())
    print ("Hough max Line Gap : %f" % edge_finder.houghMaxLineGap())
